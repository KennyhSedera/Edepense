...
export default function BudgetCard({ budgetMensuel, totalDepense, reste, user }: BudgetCardProps) {
  ...
  return (
    ...
    >
      ...
      <Text style={{ fontSize: 30, fontWeight: "800", color: "white" }}>
        {formatMoney(budgetMensuel, user?.devise || "MGA")}
      </Text>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 12 }}>
        <View>
          ...
          <Text style={{ color: "white", fontWeight: "700", fontSize: 15 }}>
            {formatMoney(totalDepense, user?.devise || "MGA")}
          </Text>
        </View>
        <View style={{ alignItems: "flex-end" }}>
          <Text style={{ color: "rgba(255,255,255,0.75)", fontSize: 12 }}>Restant</Text>
          <Text style={{ color: "white", fontWeight: "700", fontSize: 15 }}>
            {formatMoney(reste, user?.devise || "MGA")}
          </Text>
        </View>
      </View>
